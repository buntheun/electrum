...
int main(int argc, char *argv[])
{
    ...
    {
        QMessageBox::critical(0, QObject::tr("Electrum Core"),
    ...
    try {
        ...
        QMessageBox::critical(0, QObject::tr("Electrum Core"), QObject::tr("Error: %1").arg(e.what()));
        return 1;
    }
#ifdef ENABLE_WALLET
    ...
    try
    {
        ...
        WinShutdownMonitor::registerShutdownBlockReason(QObject::tr("Electrum Core didn't yet exit safely..."), (HWND)app.getMainWinId());
#endif
        app.exec();
        app.requestShutdown();
        app.exec();
