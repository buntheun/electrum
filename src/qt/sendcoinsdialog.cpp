...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    Q_FOREACH(const SendCoinsRecipient &rcp, currentTransaction.getRecipients())
    {
        ...
        QString amount = "<b>" + ElectrumUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), rcp.amount);
        amount.append("</b>");
    ...
    Q_FOREACH(ElectrumUnits::Unit u, ElectrumUnits::availableUnits())
    {
        if(u != model->getOptionsModel()->getDisplayUnit())
            alternativeUnits.append(ElectrumUnits::formatHtmlWithUnit(u, totalAmount));
    }
                                 ...
                                 const CAmount& watchBalance, const CAmount& watchUnconfirmedBalance, const CAmount& watchImmatureBalance)
{
    ...
    if(model && model->getOptionsModel())
    {
        ui->labelBalance->setText(ElectrumUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), balance));
    }
}
