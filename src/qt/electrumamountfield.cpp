...
public:
    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = fm.width(ElectrumUnits::format(ElectrumUnits::ELC, ElectrumUnits::maxMoney(), false, ElectrumUnits::separatorAlways));
...
private:
    ...
    {
        CAmount val = 0;
        bool valid = ElectrumUnits::parse(currentUnit, text, &val);
        if(valid)
        {
    ...
    amount(0)
{
    ...
    unit->setModel(new ElectrumUnits(this));
...
void ElectrumAmountField::unitChanged(int idx)
{
    ...
    int newUnit = unit->itemData(idx, ElectrumUnits::UnitRole).toInt();
