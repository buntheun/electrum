...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    int nDisplayUnit = ElectrumUnits::ELC;
    ...
    QString toolTip3 = tr("This label turns red if any recipient receives an amount smaller than %1.").arg(ElectrumUnits::formatHtmlWithUnit(nDisplayUnit, ::minRelayTxFee.GetFee(546)));
