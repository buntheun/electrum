...
typedef CElectrumExtKeyBase<CExtKey, 74, CChainParams::EXT_SECRET_KEY> CElectrumExtKey;
typedef CElectrumExtKeyBase<CExtPubKey, 74, CChainParams::EXT_PUBLIC_KEY> CElectrumExtPubKey;
