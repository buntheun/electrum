...
unlocked to sign the Electrum-Qt.app bundle.
...
allowing somebody to distribute a Electrum-Qt.app or electrum-qt-setup.exe with a valid
...
that the electrum-qt.exe file inside the installer had not been tampered with.
