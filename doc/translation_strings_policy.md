...
This document provides guidelines for internationalization of the Electrum Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `electrum_en.ts` remains unchanged.
