...
The default fee for low-priority transactions is lowered from 0.0005 ELC 
(for each 1,000 bytes in the transaction; an average transaction is
about 500 bytes) to 0.0001 ELC.

Payments (transaction outputs) of 0.543 times the minimum relay fee
(0.00005430 ELC) are now considered 'non-standard', because storing them
